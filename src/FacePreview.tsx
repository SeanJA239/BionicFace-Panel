...
// so ch31's command direction is inverted, i.e. mirror-mounted like the rest
// of the right side. With its dev negated here, the existing formulas are
// correct unchanged: tilt = dev(30) - dev(31), pitch = (dev(30) + dev(31)) / 2.
//
...
const MIRROR_PAIRS: ReadonlyArray<readonly [number, number]> = [
  ...
  // asymmetrically in their ranges (ch30 largest travel 15deg, ch31 20.5)
